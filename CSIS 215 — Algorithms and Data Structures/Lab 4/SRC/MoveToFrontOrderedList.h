...
template <typename E>
class MoveToFrontOrderedList : public SelfOrderedListADT<E> {
private:
	LList<count<E>>* list;
	int compare = 0;
public:
	//Default constructor/destructor
	MoveToFrontOrderedList() { list = new LList<count<E>>(); }
	~MoveToFrontOrderedList() {}
	...
	void printlist()  const{
		std::cout << std::endl << "Move-To-Front Heuristic: Size of list: " << size() << endl;
